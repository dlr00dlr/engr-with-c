...
int main(void)
{
	...
	if ((diff1_2 <= diff1_3)) && (diff1_2 <= diff2_3) printf("Best match is between image 1 and 2.\n");
	if ((diff1_3 <= diff1_2)) && (diff1_3 <= diff2_3) printf("Best match is between image 1 and 3.\n");
	if ((diff2_3 <= diff1_3)) && (diff2_3 <= diff1_2) printf("Best match is between image 2 and 3.\n");
